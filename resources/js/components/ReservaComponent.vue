<template>
    <div class="container">
        ...
        <button class="btn btn-info btn-block mt-3"> Buscar Asientos</button>

        <template v-for="n in filas">
                ...
                <template v-for="i in columnas">
                    <div class="">
                        <label class="super-happy">
                            ...
                            <input type="checkbox" v-model="butacas" class="super-happy"/>
        ...
        <button class="btn btn-success btn-block mt-3"> Confirmar Reserva</button>
